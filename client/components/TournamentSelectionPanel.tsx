...
interface TournamentSelectionPanelProps {
  isVisible: boolean;
  onClose: () => void;
  onSelect: (tournamentPath: string) => void;
}

export const TournamentSelectionPanel: React.FC<TournamentSelectionPanelProps> = ({
  isVisible,
  onClose,
  onSelect,
}) => {
  ...
  const tournamentOptions = [
    {
      id: 'events',
      icon: Calendar,
      title: t('tournamentselection.modes.events.title'),
      description: t('tournamentselection.modes.events.description'),
      path: '/events',
    },
    {
      id: 'results',
      icon: Award,
      title: t('tournamentselection.modes.results.title'),
      description: t('tournamentselection.modes.results.description'),
      path: '/tournament',
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-[#1A1A1A] rounded-2xl p-6 shadow-2xl max-w-md w-full mx-4">
        {/* Panel Header */}
        <div className="mb-6">
          <h2 className="text-xl font-bold text-white mb-2">{t('tournamentselection.title')}</h2>
          <p className="text-gray-400 text-sm">{t('tournamentselection.subtitle')}</p>
        </div>
...
export default TournamentSelectionPanel;
